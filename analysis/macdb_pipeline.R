...
if(grepl("ufhpc", nodename)) {
  ...
  make(all,
       force = TRUE,
       cache = cache,
       cache_log_file = here::here("analysis", "drake", "cache_log_macdb.txt"),
       verbose = 2,
  ...
  system.time(make(all, cache = cache, cache_log_file = here::here("analysis", "drake", "cache_log_macdb.txt"), parallelism = "clustermq", jobs = 2))
}
