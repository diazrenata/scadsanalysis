...
dataset <- read.csv(here::here("analysis", "rev_prototyping", "jacknifed_datasets", "fia_jk.csv"))
...
db <- DBI::dbConnect(RSQLite::SQLite(), here::here("analysis", "drake", "drake-cache-fia_short-jk.sqlite"))
...
#        force = TRUE,
#        cache = cache,
#        cache_log_file = here::here("analysis", "drake", "cache_log_fia_short_jk.txt"),
#        verbose = 1,
...
# } else {
  ...
  system.time(make(all, cache = cache, cache_log_file = here::here("analysis", "drake", "cache_log_fia_short_jk.txt"), verbose = 1, memory_strategy = "autoclean"))
#}
