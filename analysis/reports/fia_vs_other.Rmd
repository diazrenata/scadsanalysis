...
ggplot(filter(all_di), aes(simpson_percentile)) +
  geom_histogram(bins = 20) +
  theme_bw() +
  facet_wrap(vars(dat), scales = "free_y")
```
...
ggplot(sub_di, aes(skew_percentile_excl)) +
  geom_histogram()+
  theme_bw() +
  facet_wrap(vars(fia_yn), scales = "free_y")

ggplot(sub_di, aes(simpson_percentile)) +
  geom_histogram()+
  theme_bw() +
  facet_wrap(vars(fia_yn), scales = "free_y")
...
sub_di %>%
  ...
  summarize(prop_skew_high = mean(skew_percentile_excl > 95),
            prop_even_low = mean(simpson_percentile < 5),
            nsites = dplyr::n())
