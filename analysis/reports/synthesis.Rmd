...
all_di_plot <- filter(all_di, !singletons)

ggplot(all_di_plot, aes(x = log_nparts, y = simpson_mean)) +
  geom_point(alpha = .1) +
  theme_bw() +
  geom_vline(xintercept = 10)


ggplot(all_di_plot, aes(x = log_nparts, y = simpson_sd)) +
  geom_point(alpha = .1) +
  theme_bw() +
  geom_vline(xintercept = 10)


ggplot(all_di_plot, aes(x = log_nparts, y = abs(simpson_sd/simpson_mean))) +
  geom_point(alpha = .1) +
  theme_bw() +
  geom_vline(xintercept = 10)

ggplot(all_di_plot, aes(x = abs(simpson_sd/simpson_mean), y = simpson_percentile, color = log_nparts > 10)) +
  geom_point(alpha = .05) +
  theme_bw() +
  scale_color_viridis_d(end = .8)

ggplot(filter(all_di_plot, s0 > 3, !is.infinite(skew_mean), !is.infinite(skew_sd)), aes(x = log_nparts, y = skew_mean)) +
  geom_point(alpha = .1) +
  theme_bw() +
  geom_vline(xintercept = 10)


ggplot(filter(all_di_plot, s0 > 3, !is.infinite(skew_mean), !is.infinite(skew_sd)), aes(x = log_nparts, y = skew_sd)) +
  geom_point(alpha = .1) +
  theme_bw() +
  geom_vline(xintercept = 10)

ggplot(filter(all_di_plot, s0 > 3, !is.infinite(skew_mean), !is.infinite(skew_sd)), aes(x = log_nparts, y = abs(skew_sd/skew_mean))) +
  geom_point(alpha = .1) +
  theme_bw() +
  geom_vline(xintercept = 10)


ggplot(filter(all_di_plot, s0 > 3, !is.infinite(skew_mean), !is.infinite(skew_sd)), aes(x = abs(skew_sd/skew_mean), y = skew_percentile, color = log_nparts > 10)) +
  geom_point(alpha = .05) +
  theme_bw() +
  scale_color_viridis_d(end = .8) +
  xlim(0,4)
