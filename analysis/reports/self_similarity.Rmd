...
Here is div for only "small" feasible sets (those with fewer than `r exp(20)` elements in the feasible set). This lets us zoom in on the distributions where they start to broaden out.
