...
ggplot(filter(all_di, singletons == F, s0 > 2), aes(x = log(s0), y = log(n0), color = skew_95_ratio)) +
  geom_point(alpha = .5) +
  theme_bw() +
  theme(legend.position = "top") + scale_color_viridis_c(option = "magma", end = .9, begin = .1)+
  facet_wrap(vars(dat), scales = "free")
...
ggplot(filter(all_di, singletons == F), aes(x = log(s0), y = log(n0), color = simpson_95_ratio)) +
  geom_point(alpha = .5) +
  theme_bw() +
  theme(legend.position = "top") + scale_color_viridis_c(option = "magma", end = .9, begin = .1)+
  facet_wrap(vars(dat), scales = "free")

ggplot(filter(all_di, singletons == F, s0 > 2), aes(x = log_nparts, y = skew_95_ratio, color = log(n0/s0))) +
  geom_point() +
  theme_bw() +
  geom_vline(xintercept = c(10,15)) +
...
ggplot(filter(all_di, singletons == F), aes(x = log_nparts, y = simpson_95_ratio, color = log(n0/s0))) +
  geom_point() +
  theme_bw() +
  geom_vline(xintercept = c(10,15)) +
  scale_color_viridis_c()+
...
ggplot(small_di, aes(x = log_nparts, y = skew_95_ratio)) +
  geom_point() +
  theme_bw()

filter(small_di, skew_95_ratio == min(small_di$skew_95_ratio, na.rm = T))
