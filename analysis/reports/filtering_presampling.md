...
![](filtering_presampling_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
= 1) and five communities in the Misc. Abund Database that have mixed
count and relative abundance data (there are more than 5 with a mixture,
but only 5 that have both the mixture AND make it through the previous
filters).
...
``` r
miscabund_problems <- as.character(c(144, 145, 145, 146, 147, 178, 446))

all_di_filtered <- all_di_filtered %>%
  mutate(is.miscabund.problem = ifelse(dat == "misc_abund",
                                       ifelse(site %in% miscabund_problems, T, F), F))

filter(all_di_filtered, is.miscabund.problem)
```

<div class="kable-table">

|  sim | source   | dat         | site | singletons |  s0 |    n0 |        nparts |       skew |   shannon |   simpson | skew\_percentile | shannon\_percentile | simpson\_percentile | skew\_percentile\_excl | simpson\_percentile\_excl | skew\_range | simpson\_range | nsamples | skew\_unique | simpson\_unique |   skew\_2p5 | skew\_97p5 |  skew\_95 |   skew\_min | simpson\_max | simpson\_2p5 | simpson\_5 | simpson\_97p5 | skew\_95\_ratio\_2t | simpson\_95\_ratio\_2t | skew\_95\_ratio\_1t | simpson\_95\_ratio\_1t | Dataset                    | is.miscabund.problem |
| ---: | :------- | :---------- | ---: | :--------- | --: | ----: | ------------: | ---------: | --------: | --------: | ---------------: | ------------------: | ------------------: | ---------------------: | ------------------------: | ----------: | -------------: | -------: | -----------: | --------------: | ----------: | ---------: | --------: | ----------: | -----------: | -----------: | ---------: | ------------: | ------------------: | ---------------------: | ------------------: | ---------------------: | :------------------------- | :------------------- |
| \-99 | observed | misc\_abund |  144 | FALSE      |   3 |     8 |  5.000000e+00 |  0.3849002 | 0.7356219 | 0.4062500 |         80.00000 |            20.00000 |            20.00000 |                     60 |                   0.00000 |   0.7698004 |      0.2500000 |        5 |            5 |               5 | \-0.3671928 |  0.3849002 | 0.3849002 | \-0.3849002 |    0.6562500 |    0.4187500 |  0.4312500 |     0.6531250 |           0.9769975 |              0.9375000 |           1.0000000 |              0.9000000 | Miscellaneous Abundance DB | TRUE                 |
| \-99 | observed | misc\_abund |  145 | FALSE      |   3 |     6 |  3.000000e+00 |  0.0000000 | 1.0114043 | 0.6111111 |         33.33333 |            66.66667 |            66.66667 |                      0 |                  33.33333 |   0.3849002 |      0.1666667 |        3 |            3 |               3 |   0.0096225 |  0.3752777 | 0.3656552 |   0.0000000 |    0.6666667 |    0.5055556 |  0.5111111 |     0.6638889 |           0.9500000 |              0.9500000 |           0.9500000 |              0.9333333 | Miscellaneous Abundance DB | TRUE                 |
| \-99 | observed | misc\_abund |  146 | FALSE      |   3 |     6 |  3.000000e+00 |  0.0000000 | 1.0114043 | 0.6111111 |         33.33333 |            66.66667 |            66.66667 |                      0 |                  33.33333 |   0.3849002 |      0.1666667 |        3 |            3 |               3 |   0.0096225 |  0.3752777 | 0.3656552 |   0.0000000 |    0.6666667 |    0.5055556 |  0.5111111 |     0.6638889 |           0.9500000 |              0.9500000 |           0.9500000 |              0.9333333 | Miscellaneous Abundance DB | TRUE                 |
| \-99 | observed | misc\_abund |  178 | FALSE      |  22 |  1945 |  6.006488e+28 |  4.0110464 | 0.7735753 | 0.2962730 |        100.00000 |             0.00000 |             0.00000 |                    100 |                   0.00000 |   3.8013895 |      0.1758936 |     4000 |         4000 |            3929 |   0.3444461 |  2.6867950 | 2.4447349 | \-0.0615862 |    0.9437141 |    0.8685503 |  0.8779372 |     0.9349457 |           0.6161823 |              0.3774749 |           0.6593171 |              0.3739586 | Miscellaneous Abundance DB | TRUE                 |
| \-99 | observed | misc\_abund |  446 | FALSE      | 169 | 18866 | 1.195832e+133 | 10.6838177 | 3.2112728 | 0.8666905 |        100.00000 |             0.00000 |             0.00000 |                    100 |                   0.00000 |   5.4681272 |      0.0121890 |     4000 |         4000 |            3992 |   1.4360766 |  3.7340823 | 3.3200158 |   1.1750286 |    0.9896501 |    0.9829881 |  0.9836982 |     0.9885694 |           0.4202546 |              0.4578926 |           0.3922709 |              0.4882976 | Miscellaneous Abundance DB | TRUE                 |
