...
ggplot(filter(all_di, !singletons, dat != "fia_short", dat != "fia_small"), aes(x = skew_percentile)) +
  geom_histogram() +
  theme_bw()


ggplot(filter(all_di, !singletons, dat != "fia_short", dat != "fia_small"), aes(x = simpson_percentile)) +
  geom_histogram() +
  theme_bw()
