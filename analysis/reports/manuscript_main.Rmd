...
breadth_plots <- list(
  ...
  #  geom_density() +
    ...
    ggtitle("", subtitle = paste0("Breadth index (skewness): ", round((example_fs3$skew_95_ratio_1t[1]), 2))),
  ...
  #  geom_density() +
    ...
    ggtitle("", subtitle =  paste0("Breadth index (skewness): ", round((example_fs2$skew_95_ratio_1t[1]), 2))),
  ...
  ggplot(example_fs, aes(skew)) +
   # geom_density() +
    ...
    ggtitle("", subtitle =  paste0("Breadth index (skewness): ", round((example_fs$skew_95_ratio_1t[1]), 2)))
...
fig_2 <- gridExtra::grid.arrange(grobs = list(
  ...
  ggplot(filter(all_di, s0 > 2, skew_unique > 20), aes(skew_percentile_excl)) +
    ...
    theme_bw() +
    facet_wrap(vars(Dataset), scales = "free_y") + ggtitle("Skewness") +
  ...
  ggplot(filter(all_di, simpson_unique > 20), aes(simpson_percentile)) + 
    ...
    theme_bw() +
    facet_wrap(vars(Dataset), scales = "free_y") + ggtitle("Evenness") +
    xlab("Percentile rank of observed value relative to feasible set") +
    ylab("Number of communities")
))
...
fig_3 <- gridExtra::grid.arrange(grobs = list(
  ggplot(filter(all_di, s0 > 2, skew_unique > 20), aes(x= skew_95_ratio_1t)) +
    ...
    xlab("Breadth index (ranges 0-1, with 1 being very broad)") +
    ylab("Number of communities") +
    ggtitle("Skewness"),
...
```{r}
pdf("figure_1.pdf", title = "Figure 1")
plot(fig_1)
dev.off()

pdf("figure_2.pdf", title = "Figure 2")
 plot(fig_2)
 dev.off()
 
pdf("figure_3.pdf", title = "Figure 3")
plot(fig_3)
dev.off()

pdf("figure_4.pdf", title = "Figure 4")
 plot(fig_4)
dev.off()
```
