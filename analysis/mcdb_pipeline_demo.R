...
db <- DBI::dbConnect(RSQLite::SQLite(), here::here("analysis", "drake", "drake-cache-mcdb-demo.sqlite"))
...
#   options(clustermq.scheduler = "multicore")
  system.time(make(all, cache = cache, cache_log_file = here::here("analysis", "drake", "cache_log_mcdb_demo.txt"), verbose = 1, memory_strategy = "autoclean"))
#}
