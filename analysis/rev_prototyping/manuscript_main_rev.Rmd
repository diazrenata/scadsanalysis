...
plot_narrowness_hist(filter(all_di, dat %in% c("fia", "mcdb", "misc_abund")), "sim_pos_from_best", "Dissimilarity") +
  facet_wrap(vars(`Number of elements`, Dataset), scales = "free_y", nrow = 2, ncol = 3)

plot_percentile_hist(filter(all_di, dat %in% c("fia", "mcdb", "misc_abund")), "real_po_percentile_mean", "Dissimilarity") +
  facet_wrap(vars(`Number of elements`, Dataset), scales = "free_y", nrow = 2, ncol = 3)
...
ggplot(all_di, aes(s0, n0, color = `Number of elements`)) +
  geom_point() +
  xlim(0, 30) +
  ylim(0,150)
