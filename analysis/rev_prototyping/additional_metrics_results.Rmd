...
jk_di <- jk_di_full %>%
  ...
  ungroup() %>%
  select(dat, site, site_source, s0, n0, skew_percentile_excl,skew_percentile, simpson_percentile, simpson_percentile_excl, shannon_percentile, nsingletons_percentile, nsingletons_percentile_excl, nsingletons, nsingeltons_median, nsingletons_95, mean_po_comparison_percentile, mean_po_comparison_sims, mean_po_comparison_95, skew_95_ratio_1t, simpson_95_ratio_1t, shannon_95_ratio_1t, mean_po_comparison_95_ratio_1t, nparts)
...
prop_results <- all_di_with_resamples %>%
 # filter(!singletons) %>%
  ...
  summarize(
    ...
    shannon_high = mean(shannon_percentile > 97.5),
    ...
    po_high = mean(mean_po_comparison_percentile > 97.5),
