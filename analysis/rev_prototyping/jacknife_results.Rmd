...
all_di_actual <- all_di %>%
  ...
  select(dat, site_source, s0, n0, skew_percentile_excl, skew_percentile, simpson_percentile, simpson_percentile_excl, shannon_percentile, nsingletons_percentile, nsingletons_percentile_excl, nsingletons,nsingeltons_median,  nsingletons_95, mean_po_comparison_percentile, mean_po_comparison_sims, mean_po_comparison_95, skew_95_ratio_1t, simpson_95_ratio_1t, shannon_95_ratio_1t, mean_po_comparison_95_ratio_1t, nparts) 
...
jk_di_mean_results  %>% 
  group_by(dat) %>%
  filter(nparts > 20) %>%
  summarize(prop_shannon_high_jk = mean(shannon_percentile > 95),
            prop_shannon_high_raw = mean(shannon_percentile_actual > 95),
