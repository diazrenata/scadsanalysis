...
#        force = TRUE,
#        cache = cache,
#        cache_log_file = here::here("analysis", "drake", "cache_log_misc_jk.txt"),
#        verbose = 1,
...
# } else {
  ...
  system.time(make(all, cache = cache, cache_log_file = here::here("analysis", "drake", "cache_log_misc_jk.txt"), verbose = 1, memory_strategy = "autoclean"))
#}
